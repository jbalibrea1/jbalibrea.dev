      ...
      <motion.div
        ...
        style={{
          background: useMotionTemplate`
            radial-gradient(200px circle at ${mouseX}px ${mouseY}px, ${isDarkMode ? "rgba(45,134,119,0.1)" : "rgba(200,200,200,0.25)"}, transparent 80%)
          `,
        }}
      />
        ...
        <div className="flex gap-2 flex-wrap">
          {repo.tags.map((tag) => (
            ...
            >
              ...
              <span className="inline-flex h-full w-full items-center justify-center rounded-full bg-slate-50 dark:bg-zinc-900 px-3 py-1 text-xs font-medium dark:text-gray-50 text-gray-900 backdrop-blur-3xl select-all">
                {tag}
              </span>
            </div>
          ))}
